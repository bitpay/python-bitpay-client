...
class Transaction:
    ...
    def set_amount(self, value: Optional[float]):
        self.__amount = value

    def set_confirmations(self, value: Optional[int]):
        self.__confirmations = value

    def set_time(self, value: Optional[str]):
        self.__time = value

    def set_received_time(self, value: Optional[str]):
        self.__received_time = value

    def set_txid(self, value: Optional[str]):
        self.__txid = value

    def set_ex_rates(self, value: Optional[List[dict]]):
        self.__ex_rates = value

    def set_output_index(self, value: Optional[int]):
