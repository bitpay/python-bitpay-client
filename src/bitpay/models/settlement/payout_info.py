...
class PayoutInfo:
    ...
    def set_routing(self, routing: Optional[str]):
        """
    ...
    def set_merchant_ein(self, merchant_ein: Optional[str]):
        """
    ...
    def set_bank(self, bank: Optional[str]):
        """
    ...
    def set_swift(self, swift: Optional[str]):
        """
    ...
    def set_postal(self, postal: Optional[str]):
        """
    ...
    def set_sort(self, sort: Optional[str]):
        """
    ...
    def set_wire(self, wire: Optional[str]):
        """
    ...
    def set_bank_name(self, bank_name: Optional[str]):
        """
    ...
    def set_bank_address(self, bank_address: Optional[str]):
        """
    ...
    def set_bank_address2(self, bank_address2: Optional[str]):
        """
    ...
    def set_iban(self, iban: Optional[str]):
        """
    ...
    def set_additional_information(self, additional_information: Optional[str]):
        """
    ...
    def set_account_holder_name(self, account_holder_name: Optional[str]):
        """
    ...
    def set_account_holder_address(self, account_holder_address: Optional[str]):
        """
    ...
    def set_account_holder_address2(self, account_holder_address2: Optional[str]):
        """
    ...
    def set_account_holder_postal_code(self, account_holder_postal_code: Optional[str]):
        """
    ...
    def set_account_holder_city(self, account_holder_city: Optional[str]):
        """
    ...
    def set_account_holder_country(self, account_holder_country: Optional[str]):
        """
